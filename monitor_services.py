...
################
mon = Monitor.Monitor(debug=False)
mon.titles = ['Zope2.6','Zope2.7','Zope2.7',]
mon.site_list  = [
  'http://adytumsolutions.com:6080',
  'http://adytumsolutions.com:7080',
  'http://zope2.adytum.us:7080',
]
mon.warn_thresh = [ 8, 8, 8,  ]
mon.err_thresh  = [ 5, 5, 5,  ]
mon.notification_list = [
  'duncan.mcgreggor@adytumsolutions.com',
]
mon.webSiteMonitor()
